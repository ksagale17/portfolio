...
<div className="relative z-10 max-w-4xl">
  ...
  >
    The Future
          ...
          <h2
            className="text-4xl md:text-5xl text-[#1B1B1B] mb-6 leading-tight font-serif"
          >
            Jewelry is a Lifeline of Emotion, <br/>Culture and Legacy,
            <br />
          ...
          <p className="text-lg text-[#8B8985] leading-relaxed mb-4">
            ...
            identity, celebration, legacy and it tells history, reflects
            civilization.
          </p>
          ...
          {pillars.map((pillar, index) => (
            ...
            >
              <pillar.icon
                ...
                strokeWidth={1.5}
              />
              <h3 className="text-lg text-[#1B1B1B] mb-2">{pillar.title}</h3>
        ...
        <div className="mt-20 relative z-10">
          <h3
            className="text-4xl md:text-5xl text-center mb-6 font-serif text-[#1B1B1B] leading-tight"
          >
            Future Outlook
          </h3>
          <div className="w-20 h-[2px] bg-[#C7A24B] mx-auto mb-8" />

          <p className="text-lg text-center max-w-3xl mx-auto mb-12 text-[#8B8985] leading-relaxed">
            The traditional, opaque jewelry business is transitioning into a
            tech-infused, transparent, and experience-driven industry. Success
            will belong to brands that can:
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              "Build trust through radical transparency.",
              "Leverage technology for creation and customer connection.",
              "Tell compelling stories that resonate on personal and ethical levels.",
              "Offer seamless, engaging experiences across all touchpoints.",
            ].map((text, i) => (
              <div
                key={i}
                className="flex flex-col h-full relative bg-[#F6F4F1] border border-[#E5E3DF] p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow"
              >
                {/* Decorative corners */}
                ...
                <p className="text-[#1B1B1B] text-base flex-1">{text}</p>
              </div>
            ))}
          </div>
        </div>
